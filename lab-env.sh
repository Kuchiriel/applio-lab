# source este arquivo (ou use lab-py) — venv persistente + LD p/ NixOS
...
export LABPY=$HOME/.venvs/lab/bin/python
mkdir -p /tmp/opencode && ln -sfn ~/.venvs/lab /tmp/opencode/kvenv 2>/dev/null
